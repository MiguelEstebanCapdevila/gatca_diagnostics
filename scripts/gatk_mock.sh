...
bwa mem -M -t 2 hg38/hg38 SRR23019314_Whole_exome_sequence_of_a_patient_with_Harlequin_Ichthyosis_1.fastq SRR23019314_Whole_exome_sequence_of_a_patient_with_Harlequin_Ichthyosis_2.fastq > aligned.sam
